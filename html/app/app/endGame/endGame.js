...
/*-----------------------------------------------------------------------------------
                                    Controllers
-----------------------------------------------------------------------------------*/
    .controller('EndGameCtrl', function EndGameCtrl(config, $rootScope, $sce, $state, $stateParams, EventService, localStorageService, $analytics) {
		...
		console.log('gaugeEnd : ' + endGameCtrl.gaugeEnd);
