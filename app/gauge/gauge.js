         ...
         function updateGauge1(newVal, oldVal, scope){
             if(typeof newVal != 'undefined'){
                 ...
                 if (newVal != oldVal){
                     ...
                     setTimeout(function(){$('#progressBar1 i, #progressBar1 #plusGauge1 p').css('opacity', 0);}, 2500);
                     setTimeout(function(){
                     ...
                     setTimeout(function(){$('#progressBar1 i').css('opacity', 1);}, 3100);
                }
                 setTimeout(function(){
                 ...
                 if (newVal != oldVal){
                     ...
                     if(oldVal-newVal < 0){
                         ...
                         setTimeout(function(){
                            ...
                            /* $('#progressBar2 #plusGauge2 p').css('top', '15%');
                             $('#progressBar2 i').css('top', '25%');*/
                        }, 600);
                     ...
                     setTimeout(function(){
                         ...
                         /*$('#progressBar2 #plusGauge2 p').css('top', '36.5%');
                         $('#progressBar2 i').css('top', '50%');*/
                 ...
                 if (newVal != oldVal){
                     ...
                     if(oldVal-newVal < 0){
                         ...
                         setTimeout(function(){
                            ...
                            /* $('#progressBar3 #plusGauge3 p').css('top', '15%');
                             $('#progressBar3 i').css('top', '25%');*/
                        }, 600);
                     ...
                     setTimeout(function(){
                         ...
                         /*$('#progressBar3 #plusGauge3 p').css('top', '36.5%');
                         $('#progressBar3 i').css('top', '50%');*/
